    ...
    <div className="min-h-screen bg-[#020f34] text-white font-sans">
      ...
      <section className="px-6 pt-20 pb-24 max-w-7xl mx-auto ">
        ...
        <p className="text-gray-400 text-base leading-relaxed max-w-lg mb-10">
          Arinovaa Labs provides end-to-end technical solutions ranging from
          bespoke software engineering to enterprise-scale modernization. Our
          methodology prioritizes functional density and technical precision.
        </p>
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-10">
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed max-w-sm">
                Our services are designed for organizations that demand
                high-availability, scalable architectures, and seamless digital
                transformation.
              </p>
            </div>
        ...
        <div>
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-md mx-auto">
              Our methodology is rooted in the &quot;Engineering First&quot;
              principle, ensuring robust code and transparent communication.
            </p>
          </div>
          {/* Two-column bento */}
          <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-4 items-stretch">
            ...
            <div className="relative rounded-xl overflow-hidden min-h-95">
              ...
              <div className="absolute bottom-0 left-0 p-6">
                ...
                <p className="text-gray-300 text-sm leading-relaxed max-w-sm">
                  Our cloud native approach utilizes AWS, GCP, and Azure to
                  provide virtually infinite scalability for your digital
                  assets.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
              {stats.map(({ value, label, valueColor }) => (
                ...
                >
                  <p className={`text-5xl font-bold mb-3 ${valueColor}`}>
                    {value}
                  </p>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="border border-white/10 rounded-2xl px-8 py-20 flex flex-col items-center text-center bg-linear-to-br from-[#141929] via-[#0f1628] to-[#0d1221]">
          ...
          <p className="text-gray-400 text-sm leading-relaxed max-w-md mb-10">
            Consult with our engineering leads to discuss your project
            requirements and receive a detailed architectural roadmap.
          </p>
