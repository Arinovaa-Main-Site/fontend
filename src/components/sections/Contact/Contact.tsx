...
export default function ContactPage() {
    ...
    return (
        <div className="min-h-screen bg-[#171F33] text-white font-sans px-6 py-10 md:px-16 md:py-14">
            <div className="max-w-8xl">
                ...
                <p className="text-gray-400 text-sm leading-relaxed max-w-md mb-10">
                    Have a complex technical challenge? Our team of engineers and digital transformation
                ...
                <div className="mt-16 max-w-8xl">
                    ...
                    <div className="relative rounded-xl overflow-hidden h-80 md:h-105 bg-[#0d1220]">
                        <iframe
                            ...
                            style={{
                                border: 0,
                                filter: "invert(90%) hue-rotate(180deg) brightness(0.75) contrast(1.1) saturate(0.3)",
                            }}
                            allowFullScreen
                            loading="lazy"
