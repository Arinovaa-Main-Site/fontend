        ...
        <div className="min-h-screen bg-[#0d1221] text-white font-sans">
            ...
            <section className="flex flex-col items-center justify-center min-h-screen px-6 text-center">
                ...
                <p className="text-gray-400 text-base md:text-lg leading-relaxed max-w-xl mb-10">
                    Join a team of elite software engineers and digital transformation experts
                    building high-performance systems for global leaders.
                </p>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 text-base leading-relaxed mb-10 max-w-lg">
                            At Arinovaa Labs, we bypass the corporate fluff. Our culture is rooted
                            in technical excellence, deep focus, and rapid iteration. We believe in
                            providing the best tools and total autonomy.
                        </p>
