    ...
    <div className="min-h-screen bg-[#171F33] text-white font-sans flex flex-col">
      ...
      >
        ...
        <div className="relative mt-10 mb-6 w-48 h-36 flex items-center justify-center">
          ...
          {/* Small cut/scissors badge top right */}
        ...
        {/* 404 */}
        <div className="absolute w-125 h-75 rounded-full bg-[#3b5bdb] opacity-20 blur-[120px] pointer-events-none" />
        ...
        <div className="w-full mb-36 max-w-lg">
          <p className="text-center text-xs tracking-[0.2em] text-gray-500 uppercase mb-4">
            Helpful Navigation Paths
          </p>
        ...
        {/* Stack trace - bottom left decorative text */}
